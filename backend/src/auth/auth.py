...
AUTH0_DOMAIN = 'dev-bc71wn6s.us.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'Coffee'
...
def get_token_auth_header():
   ...
   if not auth_header:
       raise AuthError({
           ...
           'description': 'Authorization header not Implemented.'
       }, 401)
    ...
    if rsa_key:
       try:
          ...
          return payload
           ...
           raise AuthError({
               "code": "Invalid_claims",
               "description": "Invalid claims. Please check the audience and the issuer"
           }, 401)    
